...
*   **Postman** (Por si quieres probar la api) 
...
1. **Localizar la clase principal:** Dirígete al archivo principal del proyecto llamado `RateTheAnimeApplication.java`.
2. **Ejecutar la aplicación:** Ejecuta este archivo utilizando tu entorno o el comando de Java para compilar y correr la aplicación Spring Boot.
3. **Acceder a la plataforma:** Una vez que el servidor esté corriendo, la aplicación se desplegará localmente en el puerto `8080`.
